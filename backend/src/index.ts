...
// Auth Middleware
const auth = (req: AuthenticatedRequest, res: express.Response, next: express.NextFunction) => {
...
// Driver Routes
app.get("/api/drivers", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
...
app.post("/api/drivers", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
...
app.put("/api/drivers/:id", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
    const { id } = req.params;
...
app.delete("/api/drivers/:id", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
    const { id } = req.params;
...
// Route Routes
app.get("/api/routes", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
...
app.post("/api/routes", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
...
app.put("/api/routes/:id", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
    const { id } = req.params;
...
app.delete("/api/routes/:id", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
    const { id } = req.params;
...
// Order Routes
app.get("/api/orders", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
...
app.post("/api/orders", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
...
app.put("/api/orders/:id", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
    const { id } = req.params;
...
app.delete("/api/orders/:id", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
    const { id } = req.params;
...
app.get("/api/dashboard/stats", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
    ...
    const orders = await prisma.order.findMany();
    const totalRevenue = orders.reduce((sum: any, order: { valueRs: any; }) => sum + order.valueRs, 0);
...
app.get("/api/dashboard/kpis", auth, async (req: AuthenticatedRequest, res: express.Response) => {
  try {
    const routes = await prisma.route.findMany();
    const orders = await prisma.order.findMany({
      include: { route: true }
    ...
    orders.forEach((order: { route: { baseTimeMin: number; distanceKm: number; trafficLevel: string; routeId: any; }; deliveryTime: string; valueRs: number; }) => {
    ...
    const kpis = {
      ...
      averageOrderValue: orders.length > 0 ? orders.reduce((sum: any, order: { valueRs: any; }) => sum + order.valueRs, 0) / orders.length : 0
    };
